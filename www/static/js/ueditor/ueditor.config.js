...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
        ["bold","italic","underline","forecolor","shadowcolor","backcolor","|","justifyleft","justifycenter","justifyright",'justifyjustify', "indent","rowspacingtop",'rowspacingbottom',"lineheight",'letterspacing',"|","removeformat"],
        ['cleardoc',"fontfamily","fontsize","inserttable",'background','wordimage',"uploadword",'simpleupload',"insertimage",'insertvideo',"horizontal","|","more",'formatmatch',"autotypeset",'outpadding'],
        ["source",'remotecontent', 'spechars','emotion','link','superscript', 'subscript','insertorderedlist', 'insertunorderedlist',"|","undo","redo",'directionalityltr', 'directionalityrtl','searchreplace','fullscreen', 'help','message','imgstyle']
        ]
